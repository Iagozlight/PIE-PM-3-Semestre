...
public class MenuUsuarios extends javax.swing.JFrame {
    ...
    public MenuUsuarios(UsuariosService usuarioService, MotoristaService motoristaService) {
    ...
    private void initComponents() {
        ...
        jButton2.setText("CADASTRO DE MOTORISTA");
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {
        new exibirUsuarios(usuarioService).setVisible(true);
    }
